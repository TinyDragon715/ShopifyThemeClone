...
function App() {
  ...
  return (
    <div className="App">
      <div class="popup-floating popup-floating--left small-hide">
        <ul class="list-unstyled list-social" role="list">
          ...
          <li class="list-social__item">
            <a target="_blank" rel="noopener" href="http://instagram.com/shopify" class="list-social__link link link--text link-with-icon" aria-describedby="a11y-external-message">
        ...
        <section className='section4'>
          <div className='collage-item-left'>
            <div className='collage-card'>
              <button id="Deferred-Poster-_9VUPq3SxOc" class="card deferred-media__poster" type="button">
                ...
                <img className='media-image' src={beoplay12}></img>
              </button>
            </div>
          </div>
          <div className='collage-item-left'>
